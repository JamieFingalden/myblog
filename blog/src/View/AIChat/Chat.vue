...
<template>
  <div class="chat-container card">
    ...
    <div class="chat-layout">
      <!-- 历史会话侧边栏 -->
      <ChatHistory v-if="showSidebar" :conversations="conversations" :activeConversationId="activeConversationId"
        @select-conversation="selectConversation" @new-conversation="createNewConversation" />

      <!-- 对话窗口 -->
      <ChatWindow :conversation="activeConversation" :loading="loading" :apiError="apiError"
